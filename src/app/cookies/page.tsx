...
export default function CookiePolicy() {
  ...
  const content = {
    en: {
      ...
      content: "Cookie policy content will be added here.",
    },
    tr: {
      title: "Çerez Politikası",
      backHome: "Ana Sayfaya Dön",
      content: "Çerez politikası içeriği buraya eklenecek.",
    },
    de: {
      title: "Cookie-Richtlinie",
      backHome: "Zurück zur Startseite",
      content: "Cookie-Richtlinie Inhalt wird hier hinzugefügt.",
    },
  };
